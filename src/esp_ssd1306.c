...
esp_err_t i2c_ssd1306_init(i2c_master_bus_handle_t i2c_master_bus, const i2c_ssd1306_config_t *i2c_ssd1306_config, i2c_ssd1306_handle_t *i2c_ssd1306)
{
    ...
    uint8_t ssd1306_init_cmd[] = {
        ...
        OLED_CMD_SET_COM_PIN_HARDWARE_MAP, (i2c_ssd1306_config->height == 32) ? 0x02 : 0x12,
        OLED_CMD_SET_MEMORY_ADDR_MODE, 0x02,
        OLED_CMD_SET_CONTRAST_CONTROL, CONTRAST_OLED,
        ...
        /*
    uint8_t ssd1306_init_cmd[] = {
        0x00,       // Control Byte to transmit a command.
        0xAE,       // Display OFF
        
        //0xD5, 0x80, // Set display clock divide = 0x80
        0xA8, 0x1F, // Multiplex ratio = 31 (32-1 для 32 строк)
        0xD3, 0x00, // Display offset = 0
        0x40 | 0x0, // Start line = 0
        0xC0,       // normal com scan direction
        0xA0,       // left to right
        0x8D, 0x14, // Charge pump = enable
        0x20, 0x00, // Memory mode = horizontal
        0xA1,       // Segment remap = 127 mapped to SEG0
        0xC8,       // COM scan direction = remapped
        0xDA, 0x02, // <-- ВАЖНО! COM pins = sequential, LR remap disabled
        0x81, 0x8F, // Contrast = 0x8F
        0xD9, 0xF1, // Precharge = 0xF1
        0xDB, 0x40, // VCOMH detect = 0x40
